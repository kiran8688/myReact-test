...
class App extends Component {
  ...
  render(props) {
    ...
    var emp = (
      <center className="fs-1" >Access denied "Please login for Access"</center>
    )
    if (this.state.login) {

      var empButton = (<Button color="primary" onClick={this.revelemployeesEventHandler} />)
          ...
          {this.state.employees.map((employee, index) => {
            ...
            return (
              ...
              <Employees
                ...
                className=" mb-5 rounded-4  text-truncate  ms-5 card p-3 shadow-lg "
    ...
    return (
      ...
      <div className="App"  ><br /><br />
        ...
        <h1 className=''>{this.state.login ? this.dispOwnerTitle : this.dispNotOwner}<br></br>{empButton}</h1>
